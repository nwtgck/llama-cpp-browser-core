...
execute_process(COMMAND "${Python3_EXECUTABLE}" "${LCB_MTMD_ROOT}/scripts/prepare_mtmd.py"
    --source "${LCB_TTS_OVERLAY}" --output "${LCB_MTMD_OVERLAY}"
...
if(NOT "${LCB_TTS_INCLUDE}/clip.cpp" IN_LIST LCB_MTMD_SOURCES)
    message(FATAL_ERROR "Upstream mtmd source layout changed; review the BF16 overlay")
endif()
list(REMOVE_ITEM LCB_MTMD_SOURCES "${LCB_TTS_INCLUDE}/clip.cpp")
